...
# ADD CPP /nologo /MD /W3 /O2 /I "../../../sdks/libvorbis-1.1.2/include" /I "../../../sdks/libogg-1.1.3/include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "REAGATE_EXPORTS" /D "REANINJAM" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib winmm.lib wsock32.lib comctl32.lib /nologo /dll /map /machine:I386 /out:"../../Release/plugins/fx/reaninjam.dll" /opt:nowin98
